...
%% Version History
%  same as prePlotCalcs_v1_2; getSlectedOptima* refers to prePlotCalcs_v1_3
%  for some reason, so this file was generated to prevent errors

function [res] = prePlotCalcs_v1_3(res)
